...
As our goal is to leverage valuable data from different sources, we have scripted data processing routines to ingest original datasets in tabular format (mainly Excel Files and Comma Separated Values) and manipulate it to conform to a single file structure, using the R programming language [@rcore2024][^1]. 
