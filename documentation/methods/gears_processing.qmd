...
saveRDS(
  gwp_total_emissions3, 
  "gears_db/data/outputs/gwp_emi_edgar_fao_DO_NOT_USE.rds")
```
...
# zip::zip(
#   zipfile = "gears_db/data/outputs/gwp_total_emissions.zip",
#   files = "gears_db/data/outputs/gwp_total_emissions.csv",
#   mode = "cherry-pick"
# )
# 
# # Remove the uncompressed CSV file
# unlink("gears_db/data/outputs/gwp_total_emissions.csv")
# 
# # Total with ISIC Long Version
# 
# write.csv(
#   isic_long,
#   "gears_db/data/outputs/gwp_total_emissions_long.csv")
# 
# # Create ZIP without preserving the full folder structure
# zip::zip(
#   zipfile = "gears_db/data/outputs/gwp_total_emissions_long.zip",
#   files = "gears_db/data/outputs/gwp_total_emissions_long.csv",
#   mode = "cherry-pick"
# )
# 
# # Remove the uncompressed CSV file
# unlink("gears_db/data/outputs/gwp_total_emissions_long.csv")
# 
# # Total with ISIC Pivot Version
# 
# write.csv(
#   isic_long,
#   "gears_db/data/outputs/gwp_total_emissions_pivot.csv")
# 
# # Create ZIP without preserving the full folder structure
# zip::zip(
#   zipfile = "gears_db/data/outputs/gwp_total_emissions_pivot.zip",
#   files = "gears_db/data/outputs/gwp_total_emissions_pivot.csv",
#   mode = "cherry-pick"
# )
# 
# # Remove the uncompressed CSV file
# unlink("gears_db/data/outputs/gwp_total_emissions_pivot.csv")
...
# test <- data.frame(a = unique(gwp_total_emissions$Area), b = unique(gwp_total_emissions$ISO3) )
# write.table(test, "clipboard-128", sep = "\t", row.names = F)
# 
# write.xlsx(
#   test,
#   file = "gears_db/data/outputs/un_nigeria18_pivot_test.xlsx")
```
