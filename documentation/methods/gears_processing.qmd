...
# And save to RDS
saveRDS(gwp_edgar_total, "emdb/data/outputs/gwp_edgar_total.rds")
```
...
# write.xlsx(
#   test,
#   file = "emdb/data/outputs/un_energy_emissions_test.xlsx")
...
# write.xlsx(
#   test,
#   file = "emdb/data/outputs/un_nigeria18_pivot_test.xlsx")
```
