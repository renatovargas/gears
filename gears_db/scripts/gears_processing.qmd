...
gwp_edgar_total <- rbind(
  ...
  mutate(
    ...
    `Element Code` = case_when(
      ...
      Substance == "Emissions (CO2eq) from PFC (AR5)"  ~ 724996,
      Substance == "Emissions (CO2eq) from HFC (AR5)"  ~ 724997,
      Substance == "Emissions (CO2eq) from HCFC (AR5)" ~ 724998,
      Substance == "Emissions (CO2eq) from SF6 (AR5)"  ~ 724999,
      .default = NA
    ),
    Unit = "kt",
    `Driver Code` =
